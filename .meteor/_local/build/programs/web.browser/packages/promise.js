...
if (typeof global.Promise === "function") {                                                                         // 3
  ...
  exports.Promise = global.Promise =                                                                                // 6
    require("promise/lib/es6-extensions");                                                                          // 7
}                                                                                                                   // 8
                                                                                                                    // 9
exports.Promise.prototype.done = function (onFulfilled, onRejected) {                                               // 10
  var self = this;                                                                                                  // 11
                                                                                                                    // 12
  if (arguments.length > 0) {                                                                                       // 13
    self = this.then.apply(this, arguments);                                                                        // 14
  }                                                                                                                 // 15
                                                                                                                    // 16
  self.then(null, function (err) {                                                                                  // 17
    Meteor._setImmediate(function () {                                                                              // 18
      throw err;                                                                                                    // 19
    });                                                                                                             // 20
  });                                                                                                               // 21
};                                                                                                                  // 22
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// ../../.0.10.1.2xk8x4.rreza++os+web.browser+web.cordova/npm/node_modules/meteor-promise/package.json              //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
