...
var semver = void 0;                                                                          // 1
module1.watch(require("semver"), {                                                            // 1
...
var compatibleVersionIsInstalled = function (name, range) {                                   // 8
  try {                                                                                       // 9
    ...
    console.log(e); // XXX I guess the only error here is that the module doesn't exist?      // 17
                                                                                              //
    return false;                                                                             // 19
  }                                                                                           // 20
};                                                                                            // 21
                                                                                              //
var checkNpmVersions = function (packages, packageName) {                                     // 23
  var failures = {};                                                                          // 24
                                                                                              //
  _.forEach(packages, function (range, name) {                                                // 25
    ...
    if (failure !== true) {                                                                   // 27
      failures[name] = failure;                                                               // 28
                                                                                              ...
                                                                                              //
  if (_.keys(failures).length === 0) {                                                        // 32
    return true;                                                                              // 33
  }                                                                                           // 34
                                                                                              //
  var errors = [];                                                                            // 36
                                                                                              //
  _.forEach(failures, function (installed, name) {                                            // 37
...
////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                            //
// ../../.0.2.0.xxieaw.u2kz9++os+web.browser+web.cordova/npm/node_modules/semver/package.json //
//                                                                                            //
////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                              //
